...
3) clone this repo & run this python file jira-flask-app.py
...
PS: First webhook delivery will get 500 status code, don't panic, when you comment on issues including /jira, it will create a ticket on jira
